"""
Django settings for k_energy project.
...
SECRET_KEY = 'django-insecure-xru#8ncq26cbxs^y7985fx4cb2y&(_hhktx-hwgp!vw9ys1^4o'
...
MIDDLEWARE = [
    ...
    'authenticate.auth_middleware.LoginRequiredMiddleware',
...
WSGI_APPLICATION = 'k_energy.wsgi.application'
